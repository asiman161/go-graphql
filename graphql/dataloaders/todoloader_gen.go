...
func (l *TodoLoader) Load(key string) ([]*models.Todo, error) {
...
func (l *TodoLoader) LoadThunk(key string) func() ([]*models.Todo, error) {
	l.mu.Lock()
...
func (l *TodoLoader) LoadAll(keys []string) ([][]*models.Todo, []error) {
...
// This method should be used if you want one goroutine to make requests to many
// different data loaders without blocking until the thunk is called.
func (l *TodoLoader) LoadAllThunk(keys []string) func() ([][]*models.Todo, []error) {
	results := make([]func() ([]*models.Todo, error), len(keys))
	for i, key := range keys {
		results[i] = l.LoadThunk(key)
	}
...
func (l *TodoLoader) Prime(key string, value []*models.Todo) bool {
	l.mu.Lock()
	var found bool
...
func (l *TodoLoader) unsafeSet(key string, value []*models.Todo) {
	if l.cache == nil {
		l.cache = map[string][]*models.Todo{}
	}
	l.cache[key] = value
}
